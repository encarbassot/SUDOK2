class ElioCanvas {
    ...
    constructor(width, height,parent = undefined) {
        ...
        this.canvas.addEventListener("mousemove", (event) => {
            ...
            if(this.mouseMoved){
                this.mouseMoved(event,this._mouseX,this._mouseY)
            }
        });
        ...
        this.canvas.addEventListener("click", (event)=> {
            ...
            if(this.mouseClicked){
                this.mouseClicked(event,this._mouseX,this._mouseY)
            }
        });
    }
    ...
    text(text,x,y,size=50,font="Arial"){
